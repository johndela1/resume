...
\begin{itemize}
  \item
    domain: distributed systems, cloud infrastructure, Kubernetes, backend systems
  \item
    language: Python, Go, C, SQL, Rust, Bash, Perl, Lua, JavaScript, Ruby, Lisp, X86 and ARM asm
  \item
    technology: Linux user space and kernel, TCP/IP, PostgreSQL, MySQL, DNS BIND, Route53, AWS, Redis, Nginx, OpenBSD, Tornado, Flask,
    WebSockets, firewalls, SQLAlchemy, Netbox, FastAPI, Prometheus, Grafana, Django
  \end{itemize}

\section{WORK EXPERIENCE}

  {\large \bf Cloudflare, San Fransisco, CA, Systems Engineer \hfill 6/2024 to 5/2026}
  \begin{itemize}
  \item
    maintained netbox plugin and asset ingestion systems
  \item
    lead projects end to end.  from gathering customer  requirements, writing RFCs, creating specs, test plans, to deployment and follow up

  \item
    worked with hardware vendors to automate how hardware data was loaded into our core systems. involved moving from them sending us spreadsheets, to using HTTP API on a scheduled task, removing humans from the loop, for hardware asset ingestion.

 \item
    provided validation code to assert that all redundant data are in sync with source of truth
