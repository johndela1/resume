...
or Unix like (Linux, BSD, Solaris, etc) environment.  Willing to
...
data from third party sources (Freebase, DBpedia, etc) and transform them
...
The presentation was accessed from a REST api.  The presentation
code would do some minor transforms (flatening or showing a specific node
in the tree) on the stored data and present the results.
