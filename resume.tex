...
\begin{resume}
    ...
    between. Discovering how things work is something I enjoy and will
    have no trouble with any new hire learning curve.
\section{SKILLS}
\begin{itemize}
  \item
  ...
  \item
    ...
    Flask, Spring Boot, Elasticsearch
  \end{itemize}
\section{WORK EXPERIENCE}
  ...
  \item
    ...
    security product.  Was responsible for a variety of tasks
    including developing new code, fixing bugs, deployments, sustaining,
    testing, and operations.
  \item
    Was one of the first responders when there was a customer-facing
    issue.  This involved tracking down
  ...
  \item
    ...
    Redis (caching and pub/sub), and Elasticsearch.
  \item
  ...
  \item
    Async Python, Java, Lua, Go, .net, PostgreSQL, MySQL, AWS, Redis,
  ...
  \item
    Worked on a distributed system which was designed to count watched ads
