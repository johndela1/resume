...
\item
	Worked with Amazon AWS to build systems.

	Shared on call duty to respond to afterhours production
	issues

	=====================
DevOps Engineers at Rally Health work incredibly close with our engineering and product teams to help design, implement, and scale our predominantly Scala and MongoDB based architecture. We are obsessively focused on maintaining high availability for all of the services we manage, while also implementing the infrastructure solutions that our product teams need in order to succeed.

We're looking for an Operations Engineer to help us augment and build tools around our cloud­based environment 
    ...
    You live and breathe open source tools and most importantly, you give back to the community

------



If you have implemented and supported a cutting edge public cloud environment on top of: AWS, MongoDB, CDN, ELB; 

Responsibilities: 

    Build and maintain a highly fault tolerant infrastructure on public cloud
    Build and document cutting-edge automation tools to improve capacity and velocity for software engineers and production operations
    Collaborate with our development team to implement and evolve solutions for a wide array of challenging projects
...
Here's what you need:
    ...
    Strong Linux system administration, network troubleshooting skills
    Strong experience using open source tools; Apache, Nginx, WebApps
    Strong Programming experience in Ruby and/or Python
    Managed large Cloud production deployments, using Chef and/or Puppet
    Extensive experience managing and supporting very large-scale, public-facing websites
    Hosted and cloud-based service experience; EC2/AWS and/or Rackspace
...
\item
	...
	salt levels in a hydroponic nutrient solution and ran on small ARM
	board.	Samples would be read in from EC (electrical conductivity)
	sensor over i2c bus and used as feedback to a control loop which
