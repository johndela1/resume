...
over 10 years and has programmed in a variety of languages.

\item Expertise in backend/systems/network programming, working with
databases, sysadmin tasks (DNS, web servers, firewall).

\item Has built systems that are stable and easy to understand/debug
when issues arise.

\item Enjoys teaching, discussing code, and peer review.  \\

\item Languages:  C, Python, Bash, Lua, Tcl/TK, Scheme, \LaTeX, IA32
assembly
