...
\begin{resume}
  ...
  \item
      technology: HTTP, RDBMS (PostgreSQL, MySQL), DNS (BIND, Route53), Terraform, Linux (user and kernel), AWS (Lambda, ASG, ECS, ElasticCache (Redis), Kinesis, Security groups, etc), nginx, OpenBSD
  \item
      interviewing and mentoring
  \item
      programming
 \item
     triaging/prioritizing
  \end{itemize}
