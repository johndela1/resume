...
\item
	...
	Wrote a set of programs in Ruby which assited in a large port
	from one type of configuraton system (attributes and chef environment)
	to a existing in house system that was newly created to make the data
	available over HTTPS.

	Repurposed many of the programs described above to be used in a
	library which assited in making common changes across many
