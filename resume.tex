...
10 years and is familure with programming in a variety of languages.
He has expertise in backend/systems/network programming, working with
databases, sysadmin tasks (DNS, webservers, firewall).  He is constantly
...
transforms (flatening or showing a specific node in the tree) on the
stored data and present the results.  This was done with python, and
SQLAlchemy (on PostgreSQL).  The frontend was done with Flask.
